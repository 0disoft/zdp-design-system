...
- ResizableSplitPane은 데스크톱의 두 영역과 접근 가능한 경계선만 제공한다. 기본 폭은 280px, 기본 제한은 220–480px이며 drag, Arrow, Home/End, PageUp/PageDown, Shift 가속, 단일 click step, double-click reset을 지원한다. 실제 저장 key와 좁은 화면의 Sheet 열림 상태는 소비 앱이 정한다.
