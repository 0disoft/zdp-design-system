...
for (const requiredText of [
  ...
  '这是一个非常长的状态说明',
  'Un nombre de proyecto excepcionalmente largo',
  'Un message de vérification particulièrement long',
  'लंबे समीक्षा संदेश',
  '非常に長いプロジェクト名',
  'Chuỗi trạng thái rất dài',
  'Очень длинное сообщение',
  'Nama tugas dan pesan pemeriksaan yang sangat panjang',
  'Nama tugasan yang panjang',
  'ข้อความสถานะภาษาไทยที่ยาวมาก',
  "const targetLocales = ['en', 'zh', 'es', 'fr', 'hi', 'ko', 'ja', 'vi', 'ru', 'id', 'ms', 'th'];",
  "const activeLocales = ['ko', 'en'];",
  '12 target locales · active ko/en',
  'stress-force-focus',
  'stress-device',
  'stress-locale-card',
  'stress-focus-grid',
