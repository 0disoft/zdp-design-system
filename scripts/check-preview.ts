...
for (const requiredText of [
  ...
  'zdp-locale-switcher zdp-locale-switcher--md',
  'data-zdp-locale-switcher',
  'data-zdp-locale-value="ko"',
  'data-zdp-locale-value="en"',
  'data-zdp-locale-option-value="ko"',
  'data-zdp-locale-option-value="en"',
  'zdp-locale-switcher__label',
  'zdp-text-scale-control zdp-text-scale-control--md',
  'data-zdp-text-scale-control',
  'data-zdp-text-scale-value="base"',
  'data-zdp-text-scale-value="large"',
  ...
  'zdp-container zdp-container--lg zdp-container--padding-page',
  ...
  'zdp-skeleton__line',
  'zdp-ad-slot zdp-ad-slot--between-sections zdp-ad-slot--pending zdp-ad-slot--reserved',
  'zdp-ad-slot zdp-ad-slot--rail zdp-ad-slot--filled zdp-ad-slot--reserved',
  'zdp-ad-slot zdp-ad-slot--inline zdp-ad-slot--blocked zdp-ad-slot--reserved',
  'data-zdp-ad-slot',
  'data-zdp-ad-placement="between-sections"',
  'data-zdp-ad-placement="rail"',
  'data-zdp-ad-state="pending"',
  'data-zdp-ad-state="filled"',
  'data-zdp-ad-reserved="true"',
  'Provider, consent, script, and slot id stay in the consuming app.',
  'Reserved creative',
  'Ad unavailable',
...
for (const [iconName, expectedPath] of [
  ...
  ['weibo', siSinaweibo.path],
  ['linkedin', linkedInVendoredPath]
] as const) {
...
for (const requiredText of [
  ...
  '.zdp-text-scale-control__item[data-zdp-text-scale-option-value="larger"]',
  '.zdp-tooltip',
