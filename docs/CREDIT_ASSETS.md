...
| --- | --- | ---: | --- |
| Default mono | `credit-lemon-simple-mono.svg` | 16 CSS px | balance, compact amount, light surface |
| Inverse | `credit-lemon-simple-inverse.svg` | 16 CSS px | fixed dark surface |
...
- 색상만으로 레몬 종류, 선택 상태, 가격 우위, 추천 여부를 전달하지 않는다.
